    ...
    audioFiles: [
        {
            ...
            titles: ["开头", "了解文件系统树", "当前工作目录", "列出目录内容", "更改当前目录", "绝对路径", "相对路径", "关于文件名的重要事实",
                "一些有用的快捷键", "总结"],
            time: [[0, 570], [571, 1086],[1087,1565],[1566,2333],[2334,3136],[3145,3777],[3778,3900]],
        }, {
            fileName: ["LinuxCMD-1.mp3"],
            titles: ["Part one", "Part two", "Part three"],
            time: [[0, 300], [303, 5600], [603, 800]],
        }, {
            fileName: ["cs1.mp3"],
            titles: ["Part one", "Part two", "Part three"],
